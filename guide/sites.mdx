...
Adding a site only takes a URL — everything else is optional:

- **Website URL** — the site you want to monitor (the only required field)
- **Site name** — a display name; leave it blank and use **Auto-generate** to name it from the domain
