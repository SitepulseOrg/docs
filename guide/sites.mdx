...
Use **Run Check** to check a site right now instead of waiting for the next scheduled run. What you can run depends on your role, your plan's tools, and how many on-demand checks your team has left this month.
