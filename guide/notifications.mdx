...
SitePulse tells your team when something needs attention — when an issue opens, when it's still going (escalation), and when it clears — plus when a background manual check finishes or fails.
