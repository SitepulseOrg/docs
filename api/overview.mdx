---
title: "API Overview"
description: "Programmatic access to teams, sites, checks, reports, and notification events"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Notifications & Events" icon="bell">
    Access notification history and problem events (powered by internal issue records)
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Resources" icon="database" href="/api/resources">
    Field-by-field schemas for users, teams, sites, checks, notification events, and reports
  </Card>
