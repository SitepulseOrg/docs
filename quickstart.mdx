...
<Steps>
  ...
  <Step title="Configure monitoring and alerts">
    ...
    - **Monitoring** — check cadence, enabled tools, problem thresholds, escalation reminders, and quiet time
    - **Notifications** — email, Slack, Microsoft Teams, and webhook destinations
  </Step>
  <Step title="Review issues">
    When automatic monitoring detects problems, open **Issues** in the sidebar to acknowledge incidents and track recoveries.
  </Step>
</Steps>
